...
, rank.max_salary as Salary
from (select DepartmentId, max(Salary) as max_salary from Employee group by DepartmentId) rank
left join Employee emp
on emp.DepartmentId = rank.DepartmentId and emp.salary = rank.max_salary
left join Department dpt
on dpt.ID = rank.DepartmentId